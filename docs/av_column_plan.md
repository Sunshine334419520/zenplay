...
目标：通过 `ZenPlay` 项目，用 20–30 篇文章带读者从入门到实战，理论 + 实践并重，每篇控制在易读长度，且每章核心点不超过 200 字。
...
- 每周 2 篇，持续 3–4 个月；或每周 3 篇，持续 2–3 个月。
- 每篇 1500–3000 字，配图、代码片段与小 demo。
- 每章尽量包含“背景理论 + ZenPlay 实战 + 小练习”。

## 目标读者与收益

- 适合有 C++ 基础，想系统入门音视频的开发者；课程结束可上手实现基本播放器核心模块并理解优化要点。

---

> 文件位置：`docs/av_column_plan.md`

如需我把索引添加到 `README.md` 的“技术文档”一节或生成对应的示例代码模板（可运行 demo），我可以继续执行。